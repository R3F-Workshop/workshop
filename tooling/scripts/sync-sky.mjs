#!/usr/bin/env node
/**
 * Copy the local `@pmndrs/sky` build into `tooling/vendor/pmndrs-sky`.
 *
...
const vendored = {
  ...
  _vendoredNote:
    "Generated by tooling/scripts/sync-sky.mjs. Do not edit. Edit the sky checkout and re-run `pnpm sync:sky`.",
};
