 ...
 *
 * Usage:
 *   node tooling/scripts/build-glyphs.mjs <font-dir>
 *
...
if (!FONT_DIR) {
  console.error("usage: node tooling/scripts/build-glyphs.mjs <font-dir>");
  process.exit(1);
}
...
writeFileSync(
  OUT,
  `// GENERATED by tooling/scripts/build-glyphs.mjs — do not edit by hand.
//
...
// ExtrudeGeometry in src/app/home/sections/outcomes/components/magic-box/magic-box.tsx.
//
