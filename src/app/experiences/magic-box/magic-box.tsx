 ...
 *
 * The whole experience: a canvas and the scene inside it. Drop `<MagicBox />`
 * into any box and it fills it. Drag to turn the cube.
 *
 * The dials are Leva controls, namespaced because Leva's store is global. This
 * file never mounts the panel itself. Whatever hosts the experience decides
 * whether the controls are visible, so a page can offer them and a section can
 * leave them wired but unseen.
 *
