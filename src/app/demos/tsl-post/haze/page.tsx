...
import { PostHaze } from "@/app/experiences/tsl-post";

export const metadata: Metadata = {
  title: "Haze — R3F v10 demo",
  description:
    "Aerial perspective as a post pass that reads scene depth, on a descent from orbit to the ground.",
  robots: { index: false, follow: false },
};

export default function PostHazeDemoPage() {
  return (
      ...
      <div className="pointer-events-none absolute top-5 left-5 z-30 max-w-[min(440px,calc(100vw-2.5rem))]">
        <div className="rounded-lg bg-background/70 px-4 py-3 backdrop-blur-sm">
          ...
          <p className="mt-1.5 text-[13.5px] leading-[1.5] text-muted-foreground">
            From 400 km up to 300 m over 45 seconds. Aerial perspective is a post pass: the sky bakes how light scatters by distance, and the pass reads scene depth to apply it. Click or scroll to take the camera.
          </p>
          <PostSteps current="/demos/tsl-post/haze" />
        </div>
      </div>
    </main>
  );
